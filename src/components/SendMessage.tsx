        ...
        <>
            <div className="w-full items-center text-center px-4 mb-4 sticky bottom-0 bg-white">
                <form className="flex text-gray-900 text-xl border-4 h-fit rounded-lg border-slate-300">
                    <textarea className="w-full h-fit focus:outline-none p-1" placeholder="Type your message..."/>
                    <button type="button" className="inline-flex items-center justify-center rounded-lg px-2 py-1 transition duration-500 ease-in-out text-white bg-slack-500 hover:bg-slack-300 focus:outline-none">
